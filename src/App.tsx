...
function Routes() {
  ...
  if (route === 'waiting') return <QueueScreen filterStatus={['pedido_recebido']} title="Pedidos recebidos" />;
  if (route === 'attendance') return <QueueScreen filterStatus={['em_andamento', 'orcado', 'aprovado']} title="Em andamento" />;
  if (route === 'purchases') return <QueueScreen filterStatus={['aprovado', 'finalizada']} title="Viagens concluídas" />;
