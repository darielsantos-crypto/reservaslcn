      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          ...
          <h1 className="text-lg font-semibold text-gray-900">
            {req.segments?.[0] ? `${req.segments[0].origin} → ${req.segments[0].destination}` : req.accommodations?.[0] ? `Hospedagem em ${req.accommodations[0].city ?? 'local a definir'}` : 'Detalhes do pedido'}
          </h1>
